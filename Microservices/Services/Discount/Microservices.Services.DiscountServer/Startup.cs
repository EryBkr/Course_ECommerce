...
using Microservices.Services.DiscountServer.Services.Concrete;
using Microservices.Services.DiscountServer.Settings;
...
namespace Microservices.Services.DiscountServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Microservices.Services.DiscountServer", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservices.Services.DiscountServer v1"));
            }
