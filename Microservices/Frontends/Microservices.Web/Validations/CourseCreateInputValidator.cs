...
{
    //Kurs Kaydı için validasyon oluşturuyorum
    public class CourseCreateInputValidator:AbstractValidator<CourseCreateViewModel>
    {
        public CourseCreateInputValidator()
        {
            ...
            RuleFor(i => i.CategoryId).NotEmpty().WithMessage("Kategori alanı seçiniz");
        }
    }
}
